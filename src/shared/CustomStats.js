...
class CustomStats extends React.Component {
    render() {
        ...
        const resultsStats = config.translations && config.translations.resultsStats ?
            config.translations.resultsStats :
            (nbHits, timeSpentMS) => `${nbHits} results found in ${timeSpentMS} ms`;
        const pageStats = config.translations && config.translations.pageStats ?
